...
function createAskSdkUserAgent(customUserAgent) {
    var packageInfo = __webpack_require__(153);
...
Object.defineProperty(exports, "__esModule", { value: true });
var AskSdkUtils_1 = __webpack_require__(2);
/**
...
var DefaultRequestDispatcher = /** @class */ (function () {
    ...
    DefaultRequestDispatcher.prototype.dispatch = function (handlerInput) {
        return __awaiter(this, void 0, void 0, function () {
            var response, _i, _a, requestInterceptor, _b, _c, responseInterceptor, err_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [4 /*yield*/, this.dispatchRequest(handlerInput)];
                    case 5:
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 4:
                        ...
                        if (!adapter) {
                            throw AskSdkUtils_1.createAskSdkError(this.constructor.name, "Could not find the handler adapter that supports the request handler.");
                        }
...
Object.defineProperty(exports, "__esModule", { value: true });
var GenericRequestHandlerChain_1 = __webpack_require__(14);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var DefaultErrorMapper_1 = __webpack_require__(11);
var DefaultHandlerAdapter_1 = __webpack_require__(12);
var DefaultRequestHandlerChain_1 = __webpack_require__(13);
var DefaultRequestMapper_1 = __webpack_require__(15);
var AskSdkUtils_1 = __webpack_require__(2);
var Skill_1 = __webpack_require__(18);
...
Object.defineProperty(exports, "__esModule", { value: true });
var ask_sdk_model_1 = __webpack_require__(158);
var AttributesManagerFactory_1 = __webpack_require__(9);
var DefaultRequestDispatcher_1 = __webpack_require__(10);
var ResponseFactory_1 = __webpack_require__(16);
var AskSdkUtils_1 = __webpack_require__(2);
...
Object.defineProperty(exports, "__esModule", { value: true });
var BaseSkillFactory_1 = __webpack_require__(17);
/**
...
var Writable = __webpack_require__(172).Writable;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ask_sdk_core__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ask_sdk_core___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_ask_sdk_core__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios__ = __webpack_require__(160);
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    ...
    return handlerInput.responseBuilder.speak(speechText).reprompt(speechText).withSimpleCard('Septa Skill', speechText).getResponse();
  }
};

const SeptaIntentHandler = {
  canHandle(handlerInput) {
    return handlerInput.requestEnvelope.request.type === 'IntentRequest' && handlerInput.requestEnvelope.request.intent.name === 'SeptaIntent';
  },
  async handle(handlerInput) {
    ...
    if (!regionalRail || !theStation || !direction) {
      return handlerInput.responseBuilder.speak(`You need to provide a regional rail and station, something like. ask Septa
          to give me the next Doylestown train at Suburban Station
        `).getResponse();
    }

    const response = await __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(`http://www3.septa.org/hackathon/Arrivals/${theStation.trimRight()}/30`);

    if (response.status == 400) {
      return handlerInput.responseBuilder.speak(`Hmm, sorry I cannot seem to find that station, some stations are, 30th street station, 
    ...
    arrival = arrival[direction].find(train => {
      return train.line.toLowerCase() === regionalRail;
    });

    if (arrival) {
      return handlerInput.responseBuilder.speak(`The next ${regionalRail} train, coming to ${station}, scheduled for ${__WEBPACK_IMPORTED_MODULE_2_moment___default()(arrival.sched_time).format('h:mm A')},
    ...
    return handlerInput.responseBuilder.speak(`Could not find any ${regionalRail} train coming to ${station}`).getResponse();
  }
};
...
const skillBuilder = __WEBPACK_IMPORTED_MODULE_0_ask_sdk_core__["SkillBuilders"].custom();

const handler = skillBuilder.addRequestHandlers(LaunchRequestHandler, SeptaIntentHandler, HelpIntentHandler, CancelAndStopIntentHandler, SessionEndedRequestHandler).addErrorHandlers(ErrorHandler).lambda();
...
var ImageHelper_1 = __webpack_require__(154);
exports.ImageHelper = ImageHelper_1.ImageHelper;
var PlainTextContentHelper_1 = __webpack_require__(155);
...
var DefaultApiClient = /** @class */ (function () {
    ...
    DefaultApiClient.prototype.invoke = function (request) {
        ...
        var client = clientRequestOptions.protocol === 'https:' ? __webpack_require__(5) : __webpack_require__(6);
...
var url = __webpack_require__(4);
var zlib = __webpack_require__(180);
var pkg = __webpack_require__(181);
var createError = __webpack_require__(8);
var enhanceError = __webpack_require__(22);
...
try {
  var supportsColor = __webpack_require__(179);
